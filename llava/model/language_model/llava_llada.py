    ...
    def generate(
        ...
        **kwargs,
        ...
        if images is not None:
            (inputs, position_ids, attention_mask, _, inputs_embeds, _, prefix_input_ids) = self.prepare_inputs_labels_for_multimodal(inputs, position_ids, attention_mask, None, None, images, modalities, image_sizes=image_sizes, return_inputs=True)
            kwargs.setdefault("vrcd_prefix_input_ids", prefix_input_ids)
            kwargs.setdefault("vrcd_image_token_id", IMAGE_TOKEN_INDEX)
        else:
            # breakpoint()
